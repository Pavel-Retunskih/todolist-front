...
import { useVitalTasksStatistic } from '@/view/vital-view/model/useVitalTasksStatistic.ts'
import VitalTaskCard from '@/view/vital-view/ui/vital-task-card.vue'
import { useTasksQuery } from '@/entities/tasks/model/useTasksQuery.ts'
import { useStorage } from '@vueuse/core'

import VitalFilters from '@/view/vital-view/ui/vital-filters.vue'
import VitalStatistic from '@/view/vital-view/ui/vital-statistic.vue'
